...
DT_LSY4812_5A_2 <- DataTrack_fw_rev(GRanges = LSY4812_5A_2_smooth_roi, fw_col = adjustcolor(col = fw_col, alpha.f = 0.33), rev_col = adjustcolor(col = rev_col, alpha.f = 0.33), type = "l", ylim = ylim_smooth, name = "No_P")
...
plotTracks(trackList = list(OverlayTrack(trackList = list(DT_LSY4812_5A_2, DT_LSY4811_11B_2, DT_LSY4810_41D_2)), AT),
...
# construct DataTracks for smoothed data
DT_LSY4810_41D_2 <- DataTrack_fw_rev(GRanges = LSY4810_41D_2_smooth_roi, fw_col = adjustcolor(col = fw_col, alpha.f = 0.33), rev_col = adjustcolor(col = rev_col, alpha.f = 0.33), type = "l", ylim = ylim_smooth, name = "No_P")
...
DT_LSY4812_5A_2 <- DataTrack_fw_rev(GRanges = LSY4812_5A_2_smooth_roi, fw_col = adjustcolor(col = fw_col, alpha.f = 0.67), rev_col = adjustcolor(col = rev_col, alpha.f = 0.67), type = "l", ylim = ylim_smooth, name = "P_ACT1")

AT_w_REcs <- HighlightTrack(trackList = list(AT), range = shift(DSB, -565), col = "black", lty = "dotted", fill = NA, inBackground = FALSE)

# plot
pdf(file = "tmp.pdf", width = 3.5, height = 2)
plotTracks(trackList = list(OverlayTrack(trackList = list(DT_LSY4810_41D_2, DT_LSY4812_5A_2, DT_LSY4811_11B_2)), AT),
