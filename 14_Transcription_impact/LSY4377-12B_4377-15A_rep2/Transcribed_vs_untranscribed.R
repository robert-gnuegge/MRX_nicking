...
plot_dir <- "/home/robert/Research/Manuscripts/My_manuscripts/20-04-17-MRX_nicking_manuscript/Figures/11_Transcription_impact/LSY4377-12B_4377-15A_rep2/Transcribed_vs_untranscribed"
...
LSY4377_12B_1 <- subsetByIntersect(subject = LSY4377_12B_1_rep2_S1_seq, query = roi)
LSY4377_12B_2 <- subsetByIntersect(subject = LSY4377_12B_2_rep2_S1_seq, query = roi)
LSY4377_12B_4 <- subsetByIntersect(subject = LSY4377_12B_4_rep2_S1_seq, query = roi)
...
par(cex = 1, mar = c(5.1, 4.1, 4.1, 2.1) - c(1.5, 0.6, 4, 1.6), tcl = -0.3, mgp = c(2.5, 0.6, 0), las = 1)
  ...
  plot(x = x, y = y, ylim = c(0, trans(x = 500, threshold = th, threshold_trans = th_t, factor = f)), 
...
par(cex = 1, mar = c(5.1, 4.1, 4.1, 2.1) - c(1.5, 0.6, 4, 1.6), tcl = -0.3, mgp = c(2.5, 0.6, 0), las = 1)
  ...
  f <- 0.3
  y <- trans(x = y, threshold = th, threshold_trans = th_t, factor = f)
  plot(x = x, y = y, ylim = c(0, trans(x = 90, threshold = th, threshold_trans = th_t, factor = f)), 
       xlim = c(0, 1500), ylab = "Average S1-seq [RPM]", xlab = "Distance from DSB [nt]", 
       type = "l", lwd = 1.5, col = JFly_colors[1], yaxt = "n")
...
par(cex = 1, mar = c(5.1, 4.1, 4.1, 2.1) - c(1.5, 0.6, 4, 1.6), tcl = -0.3, mgp = c(2.5, 0.6, 0), las = 1)
  ...
  plot(x = x, y = y, ylim = c(0, trans(x = 415, threshold = th, threshold_trans = th_t, factor = f)), 
       xlim = c(0, 1500), ylab = "Average S1-seq [RPM]", xlab = "Distance from DSB [nt]", 
       type = "l", lwd = 1.5, col = JFly_colors[1], yaxt = "n")
...
par(cex = 1, mar = c(5.1, 4.1, 4.1, 2.1) - c(1.5, 0.6, 4, 1.6), tcl = -0.3, mgp = c(2.5, 0.6, 0), las = 1)
  ...
  plot(x = x, y = y, ylim = c(0, trans(x = 120, threshold = th, threshold_trans = th_t, factor = f)), 
       xlim = c(0, 1500), ylab = "Average S1-seq [RPM]", xlab = "Distance from DSB [nt]", 
       type = "l", lwd = 1.5, col = JFly_colors[1], yaxt = "n")
...
par(cex = 1, mar = c(5.1, 4.1, 4.1, 2.1) - c(1.5, 0.6, 4, 1.6), tcl = -0.3, mgp = c(2.5, 0.6, 0), las = 1)
  ...
  plot(x = x, y = y, ylim = c(0, trans(x = 425, threshold = th, threshold_trans = th_t, factor = f)), 
       xlim = c(0, 1500), ylab = "Average S1-seq [RPM]", xlab = "Distance from DSB [nt]", 
       type = "l", lwd = 1.5, col = JFly_colors[1], yaxt = "n")
