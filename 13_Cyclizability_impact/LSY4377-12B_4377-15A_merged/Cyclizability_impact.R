...
plot_dir <- "/home/robert/Research/Manuscripts/My_manuscripts/20-04-17-MRX_nicking_manuscript/Figures/10_Cyclizability_impact/LSY4377-12B_4377-15A_merged"
...
LSY4377_12B_1 <- subsetByIntersect(subject = LSY4377_12B_1_merged_S1_seq_unnormalized, query = DSB_regions(DSBs = SrfIcs[4:5], region_width = 4000, up_rev_down_fw = TRUE))
LSY4377_12B_2 <- subsetByIntersect(subject = LSY4377_12B_2_merged_S1_seq_unnormalized, query = DSB_regions(DSBs = SrfIcs[4:5], region_width = 4000, up_rev_down_fw = TRUE))
LSY4377_12B_4 <- subsetByIntersect(subject = LSY4377_12B_4_merged_S1_seq_unnormalized, query = DSB_regions(DSBs = SrfIcs[4:5], region_width = 4000, up_rev_down_fw = TRUE))
