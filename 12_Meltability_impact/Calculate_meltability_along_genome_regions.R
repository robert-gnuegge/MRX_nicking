...
load(file = paste0(save_dir, "/Melting_10bp.RData"))
...
save(melting_15bp, file = paste0(save_dir, "/Melting_15bp.RData"))
load(file = paste0(save_dir, "/Melting_15bp.RData"))
...
# save results ============================================================
save(list = c("Melting_profiles_10bp", "Melting_profiles_15bp"), file = paste0(save_dir, "/Melting_profiles.RData"))
