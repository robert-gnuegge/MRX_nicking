...
LSY4377_12B_0_S1_seq <- subsetByIntersect(subject = LSY4377_12B_0_rep2_S1_seq, query = DSB_regions(DSBs = SrfIcs, region_width = 10000))
LSY4377_12B_1_S1_seq <- subsetByIntersect(subject = LSY4377_12B_1_rep2_S1_seq, query = DSB_regions(DSBs = SrfIcs, region_width = 10000))
LSY4377_12B_2_S1_seq <- subsetByIntersect(subject = LSY4377_12B_2_rep2_S1_seq, query = DSB_regions(DSBs = SrfIcs, region_width = 10000))
LSY4377_12B_4_S1_seq <- subsetByIntersect(subject = LSY4377_12B_4_rep2_S1_seq, query = DSB_regions(DSBs = SrfIcs, region_width = 10000))
LSY4377_15A_4_S1_seq <- subsetByIntersect(subject = LSY4377_15A_4_rep2_S1_seq, query = DSB_regions(DSBs = SrfIcs, region_width = 10000))
...
plot_dir <- "/home/robert/Research/Manuscripts/My_manuscripts/20-04-17-MRX_nicking_manuscript/Figures/04_S1-seq_next_to_DSBs/LSY4377-12B_4377-15A_rep2"
