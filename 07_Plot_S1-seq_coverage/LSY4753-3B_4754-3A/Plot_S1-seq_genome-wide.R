...
load(file = "/home/robert/Research/Manuscripts/My_manuscripts/20-04-17-MRX_nicking_manuscript/Data/S1-seq/LSY4753-3B_4754-3A/LSY4753-3B_4754-3A_w_chrM_and_2micron.RData")
...
LSY4753_3B_2 <- sum_scores_in_bins(GRanges = as_GRanges_with_fw_rev_scores(GRanges = LSY4753_3B_2_S1_seq_w_chrM_and_2micron, rev_negative = TRUE), bins = bins)
LSY4754_3A_2 <- sum_scores_in_bins(GRanges = as_GRanges_with_fw_rev_scores(GRanges = LSY4754_3A_2_S1_seq_w_chrM_and_2micron, rev_negative = TRUE), bins = bins)

# find y range that covers all sample score ranges ------------------------
y_range <- range(c(LSY4753_3B_2$fw, LSY4753_3B_2$rev, LSY4754_3A_2$fw, LSY4754_3A_2$rev))
...
LSY4753_3B_2_DT <- DataTrack(LSY4753_3B_2, ylim = y_range)
LSY4754_3A_2_DT <- DataTrack(LSY4754_3A_2, ylim = y_range)
...
for (sample in c("LSY4753_3B_2", "LSY4754_3A_2")){
