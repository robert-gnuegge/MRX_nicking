...
load(file = "/home/robert/Research/Manuscripts/My_manuscripts/20-04-17-MRX_nicking_manuscript/Data/S1-seq/LSY4602-20C_1/LSY4602-20C_1_w_chrM_and_2micron.RData")
...
LSY4602_20C_1 <- sum_scores_in_bins(GRanges = as_GRanges_with_fw_rev_scores(GRanges = LSY4602_20C_1_S1_seq_w_chrM_and_2micron, rev_negative = TRUE), bins = bins)

# find y range that covers all sample score ranges ------------------------
y_range <- range(c(LSY4602_20C_1$fw, LSY4602_20C_1$rev))
...
LSY4602_20C_1_DT <- DataTrack(LSY4602_20C_1, ylim = y_range)
