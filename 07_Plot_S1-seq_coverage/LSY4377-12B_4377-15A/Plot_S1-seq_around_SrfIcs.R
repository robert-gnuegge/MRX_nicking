...
LSY4377_12B_0_S1_seq <- subsetByOverlaps(x = LSY4377_12B_0_S1_seq, ranges = DSB_regions(DSBs = SrfIcs, region_width = 10000))
LSY4377_12B_1_S1_seq <- subsetByOverlaps(x = LSY4377_12B_1_S1_seq, ranges = DSB_regions(DSBs = SrfIcs, region_width = 10000))
LSY4377_12B_2_S1_seq <- subsetByOverlaps(x = LSY4377_12B_2_S1_seq, ranges = DSB_regions(DSBs = SrfIcs, region_width = 10000))
LSY4377_12B_4_S1_seq <- subsetByOverlaps(x = LSY4377_12B_4_S1_seq, ranges = DSB_regions(DSBs = SrfIcs, region_width = 10000))
LSY4377_15A_4_S1_seq <- subsetByOverlaps(x = LSY4377_15A_4_S1_seq, ranges = DSB_regions(DSBs = SrfIcs, region_width = 10000))
...
plot_dir <- "/home/robert/Research/Manuscripts/My_manuscripts/20-04-17-MRX_nicking_manuscript/Figures/04_S1-seq_next_to_DSBs/LSY4377-12B_4377-15A"
