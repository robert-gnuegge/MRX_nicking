...
plot_dir <- "/home/robert/Research/Manuscripts/My_manuscripts/20-04-17-MRX_nicking_manuscript/Figures/01_S1-seq_edit_distance_distributions/LSY4602-20C_1"

# initialize data.frames for result recording
mapping_stats <- data.frame()

# iterate through samples
samples <- "LSY4602-20C_1"
...
# save data ---------------------------------------------------------------
save(list = paste0(dash_to_underscore(samples), "_S1_seq"), file = paste0(save_dir, "/LSY4602-20C_1.RData"))
save(list = paste0(dash_to_underscore(samples), "_S1_seq_unnormalized"), file = paste0(save_dir, "/LSY4602-20C_1_unnormalized.RData"))
save(list = paste0(dash_to_underscore(samples), "_S1_seq_w_chrM_and_2micron"), file = paste0(save_dir, "/LSY4602-20C_1_w_chrM_and_2micron.RData"))

write.table(x = mapping_stats, file = paste0(save_dir, "/LSY4602-20C_1_mapping_stats.txt"), row.names = FALSE)