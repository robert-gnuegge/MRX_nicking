...
save_dir <- "/home/robert/Research/Manuscripts/My_manuscripts/20-04-17-MRX_nicking_manuscript/Data/MNase-seq/LSY4377-12B_4377-15A"
plot_dir_edit <- "/home/robert/Research/Manuscripts/My_manuscripts/20-04-17-MRX_nicking_manuscript/Figures/12_MNase-seq_edit_distance_distributions/LSY4377-12B_4377-15A"
plot_dir_insert <- "/home/robert/Research/Manuscripts/My_manuscripts/20-04-17-MRX_nicking_manuscript/Figures/12_MNase-seq_insert_size_distributions/LSY4377-12B_4377-15A"

# initialize data.frames for result recording
mapping_stats <- data.frame()

# iterate through samples
samples <- paste0("LSY4377-12B_", c(0, 1, 2, 4))
...
# save data ---------------------------------------------------------------
save(list = paste0(dash_to_underscore(samples), "_MNase_seq"), file = paste0(save_dir, "/LSY4377-12B_LSY4377-15A.RData"))
save(list = paste0(dash_to_underscore(samples), "_MNase_seq_trimmed"), file = paste0(save_dir, "/LSY4377-12B_LSY4377-15A_trimmed.RData"))
