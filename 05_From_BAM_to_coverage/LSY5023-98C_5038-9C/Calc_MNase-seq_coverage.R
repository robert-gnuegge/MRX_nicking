...
save_dir <- "/home/robert/Research/Manuscripts/My_manuscripts/20-04-17-MRX_nicking_manuscript/Data/MNase-seq/LSY5023-98C_5038-9C"
plot_dir_edit <- "/home/robert/Research/Manuscripts/My_manuscripts/20-04-17-MRX_nicking_manuscript/Figures/12_MNase-seq_edit_distance_distributions/LSY5023-98C_5038-9C"
plot_dir_insert <- "/home/robert/Research/Manuscripts/My_manuscripts/20-04-17-MRX_nicking_manuscript/Figures/12_MNase-seq_insert_size_distributions/LSY5023-98C_5038-9C"

# initialize data.frames for result recording
mapping_stats <- data.frame()

# iterate through samples
samples <- c("LSY5023-98C_0", "LSY5023-98C_2", "LSY5038-9C_0", "LSY5038-9C_2")
...
# save data ---------------------------------------------------------------
save(list = paste0(dash_to_underscore(samples), "_MNase_seq"), file = paste0(save_dir, "/LSY5023-98C_5038-9C.RData"))
save(list = paste0(dash_to_underscore(samples), "_MNase_seq_trimmed"), file = paste0(save_dir, "/LSY5023-98C_5038-9C_trimmed.RData"))
write.table(x = mapping_stats, file = paste0(save_dir, "/LSY5023-98C_5038-9C_mapping_stats.txt"), row.names = FALSE)