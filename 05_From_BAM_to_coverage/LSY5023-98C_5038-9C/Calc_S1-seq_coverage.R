...
save_dir <- "/home/robert/Research/Manuscripts/My_manuscripts/20-04-17-MRX_nicking_manuscript/Data/S1-seq/LSY5023-98C_5038-9C"
plot_dir <- "/home/robert/Research/Manuscripts/My_manuscripts/20-04-17-MRX_nicking_manuscript/Figures/01_S1-seq_edit_distance_distributions/LSY5023-98C_5038-9C"

# initialize data.frames for result recording
mapping_stats <- data.frame()

# iterate through samples
samples <- c("LSY5023-98C_2", "LSY5038-9C_2")
...
# save data ---------------------------------------------------------------
save(list = paste0(dash_to_underscore(samples), "_S1_seq"), file = paste0(save_dir, "/LSY5023-98C_5038-9C.RData"))
save(list = paste0(dash_to_underscore(samples), "_S1_seq_unnormalized"), file = paste0(save_dir, "/LSY5023-98C_5038-9C_unnormalized.RData"))
save(list = paste0(dash_to_underscore(samples), "_S1_seq_w_chrM_and_2micron"), file = paste0(save_dir, "/LSY5023-98C_5038-9C_w_chrM_and_2micron.RData"))
