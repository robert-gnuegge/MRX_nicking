...
save_dir <- "/home/robert/Research/Manuscripts/My_manuscripts/20-04-17-MRX_nicking_manuscript/Data/S1-seq/LSY4810-41D_4811-11B_4812-5A"
plot_dir <- "/home/robert/Research/Manuscripts/My_manuscripts/20-04-17-MRX_nicking_manuscript/Figures/01_S1-seq_edit_distance_distributions/LSY4810-41D_4811-11B_4812-5A"

# initialize data.frames for result recording
mapping_stats <- data.frame()

# iterate through samples
samples <- c("LSY4810-41D_2", "LSY4811-11B_2", "LSY4812-5A_2")
sample <- samples[1]
for(sample in samples){
  ...
  # save RPM normalized coverage with (for genome-wide S1-seq coverage) and without chrM and 2micron
...
# save data ---------------------------------------------------------------
save(list = paste0(dash_to_underscore(samples), "_S1_seq"), file = paste0(save_dir, "/LSY4810-41D_4811-11B_4812-5A.RData"))
save(list = paste0(dash_to_underscore(samples), "_S1_seq_unnormalized"), file = paste0(save_dir, "/LSY4810-41D_4811-11B_4812-5A_unnormalized.RData"))
save(list = paste0(dash_to_underscore(samples), "_S1_seq_w_chrM_and_2micron"), file = paste0(save_dir, "/LSY4810-41D_4811-11B_4812-5A_w_chrM_and_2micron.RData"))

write.table(x = mapping_stats, file = paste0(save_dir, "/LSY4810-41D_4811-11B_4812-5A_mapping_stats.txt"), row.names = FALSE)