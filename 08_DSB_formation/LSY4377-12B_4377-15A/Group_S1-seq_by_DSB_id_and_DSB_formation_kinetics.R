...
LSY4377_12B_0_S1_seq <- subsetByIntersect(subject =LSY4377_12B_0_S1_seq, query = roi)
LSY4377_12B_1_S1_seq <- subsetByIntersect(subject =LSY4377_12B_1_S1_seq, query = roi)
LSY4377_12B_2_S1_seq <- subsetByIntersect(subject =LSY4377_12B_2_S1_seq, query = roi)
LSY4377_12B_4_S1_seq <- subsetByIntersect(subject =LSY4377_12B_4_S1_seq, query = roi)
LSY4377_15A_4_S1_seq <- subsetByIntersect(subject =LSY4377_15A_4_S1_seq, query = roi)
...
# (for calculating averages over mutliple DSBs)
...
# save
resection_extend_LSY4377_12B_1 <- resection_extend_1
resection_extend_LSY4377_12B_2 <- resection_extend_2
resection_extend_LSY4377_12B_4 <- resection_extend_4
save(list = c("resection_extend_LSY4377_12B_1", "resection_extend_LSY4377_12B_2", "resection_extend_LSY4377_12B_4"),
     file = paste0(save_dir, "/LSY4377-12B_LSY4377-15A_resection_extend.RData"))
...
par(cex = 1, mar = c(5.1, 4.1, 4.1, 2.1) - c(0.3, -0.5, -0, 2), tcl = -0.3, mgp = c(3.5, 0.6, 0), las = 1)
  ...
  text(x = 1:length(DSBs), y = par("usr")[3] - 0.025 * (par("usr")[4] - par("usr")[3]), srt = 45, 
       labels = S1_seq_frac$DSB_id[S1_seq_frac$time == 1][idx], xpd = TRUE, adj = c(1,1), font = c(2, rep(1, 6), 2, 1, 2, 1, 1, 2, 1, 2, rep(1, 4)))
...
# save data
LSY4377_12B_0_S1_seq <- LSY4377_12B_0
LSY4377_12B_1_S1_seq <- LSY4377_12B_1
LSY4377_12B_2_S1_seq <- LSY4377_12B_2
LSY4377_12B_4_S1_seq <- LSY4377_12B_4
LSY4377_15A_4_S1_seq <- LSY4377_15A_4
save(list = c("LSY4377_12B_0_S1_seq", "LSY4377_12B_1_S1_seq", "LSY4377_12B_2_S1_seq", "LSY4377_12B_4_S1_seq", "LSY4377_15A_4_S1_seq"),
     file = paste0(save_dir, "/LSY4377-12B_LSY4377-15A_around_DSBs.RData"))
...
bp <- boxplot(at = at, score ~ DSB_kinetics + time, data = unprocessed_DSB_frac, outline = FALSE, col = NA, border = "gray",
              xlab = "DSB Kinetics", ylab = "Unprocessed DSB Fraction", names = rep(NA, 9), xaxt = "n", ylim = c(0, 0.11))
