...
SrfIcs$score <- subsetByIntersect(query = SrfIcs, subject = LSY4377_15A_4_rep2_S1_seq)$score
mm_SrfIcs$score <- subsetByIntersect(query = mm_SrfIcs, subject = LSY4377_15A_4_rep2_S1_seq)$score
bg$score <- subsetByIntersect(query = bg, subject = LSY4377_15A_4_rep2_S1_seq)$score
...
par(cex = 1, mar = c(5.1, 4.1, 4.1, 2.1) - c(3.6, 0.6, 0.4, 2), xpd = TRUE, las=1, tcl = -0.25, mgp = c(2.25, 0.5, 0))
  ...
  y0 = 23.5
  y_step = 3
  add_significance(x0 = 1, x1 = 2, y = y0, text_offset = -0.5, x_shrink = 0.1, text = expression("p = 1"))
