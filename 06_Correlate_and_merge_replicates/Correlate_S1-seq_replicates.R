...
plot_dir <- "/home/robert/Research/Manuscripts/My_manuscripts/20-04-17-MRX_nicking_manuscript/Figures/02_Replicate_correlation/S1-seq"
...
LSY4377_12B_0_rep1 <- sort(x = as_nt_resolved_GRanges(GRanges = subsetByIntersect(subject = LSY4377_12B_0_S1_seq, query = roi)), ignore.strand = FALSE)
LSY4377_12B_1_rep1 <- sort(x = as_nt_resolved_GRanges(GRanges = subsetByIntersect(subject = LSY4377_12B_1_S1_seq, query = roi)), ignore.strand = FALSE)
LSY4377_12B_2_rep1 <- sort(x = as_nt_resolved_GRanges(GRanges = subsetByIntersect(subject = LSY4377_12B_2_S1_seq, query = roi)), ignore.strand = FALSE)
LSY4377_12B_4_rep1 <- sort(x = as_nt_resolved_GRanges(GRanges = subsetByIntersect(subject = LSY4377_12B_4_S1_seq, query = roi)), ignore.strand = FALSE)
LSY4377_15A_4_rep1 <- sort(x = as_nt_resolved_GRanges(GRanges = subsetByIntersect(subject = LSY4377_15A_4_S1_seq, query = roi)), ignore.strand = FALSE)
LSY4377_12B_0_rep2 <- sort(x = as_nt_resolved_GRanges(GRanges = subsetByIntersect(subject = LSY4377_12B_0_rep2_S1_seq, query = roi)), ignore.strand = FALSE)
LSY4377_12B_1_rep2 <- sort(x = as_nt_resolved_GRanges(GRanges = subsetByIntersect(subject = LSY4377_12B_1_rep2_S1_seq, query = roi)), ignore.strand = FALSE)
LSY4377_12B_2_rep2 <- sort(x = as_nt_resolved_GRanges(GRanges = subsetByIntersect(subject = LSY4377_12B_2_rep2_S1_seq, query = roi)), ignore.strand = FALSE)
LSY4377_12B_4_rep2 <- sort(x = as_nt_resolved_GRanges(GRanges = subsetByIntersect(subject = LSY4377_12B_4_rep2_S1_seq, query = roi)), ignore.strand = FALSE)
LSY4377_15A_4_rep2 <- sort(x = as_nt_resolved_GRanges(GRanges = subsetByIntersect(subject = LSY4377_15A_4_rep2_S1_seq, query = roi)), ignore.strand = FALSE)
...
all(granges(LSY4377_15A_4_rep1) == granges(LSY4377_15A_4_rep2))
...
file_name <- paste0(plot_dir, "/LSY4377_15A_4.png")
png(filename = file_name, width = 3, height = 3, units = "in", res = 900)
par(cex = 1, mar = c(5.1, 4.1, 4.1, 2.1) - c(1.7, 0.5, 3.8, 1.8), tcl = -0.3, mgp = c(2.5, 0.6, 0), las = 1)
  plot_correlation(rep1 = log10(x = LSY4377_15A_4_rep1$score + 1), rep2 = log10(x = LSY4377_15A_4_rep2$score + 1))
dev.off()
...
par(cex = 1, mar = c(5.1, 4.1, 4.1, 2.1) - c(1.7, 0.5, 3.8, 1.8), tcl = -0.3, mgp = c(2.5, 0.6, 0), las = 1)
  plot_correlation(rep1 = log10(x = LSY4377_15A_4_rep1$score + 1), rep2 = log10(x = LSY4377_15A_4_rep2$score + 1))
dev.off()
GS_embed_fonts(input = "tmp.pdf", output = paste0(plot_dir, "/LSY4377_15A_4.pdf"))